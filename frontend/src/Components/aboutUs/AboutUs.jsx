...
const SmallCard = ({ image, title }) => (
  <div className="w-[300px] h-[250px] bg-cover relative shadow-lg" style={{ backgroundImage: `url(${image})` }}>
    ...
    <div>
      ...
      <div className="mt-32 bg-gray-300 w-[85vw] m-auto p-2 flex">
        ...
        <div className="w-[60%] flex flex-col justify-around text-2xl ml-5">
          ...
          <div className="flex justify-center h-fit gap-4">
            <p className="w-fit border-2 p-2">
              <strong className="text-3xl">25,358 </strong>employees dedicated to our customers’ success
            </p>
            <p className="w-fit border-2 p-2">
              Founded in <strong className="text-3xl">1955</strong>
            </p>
            <p className="w-fit border-2 p-2">
              Nearly <strong className="text-3xl">3.4 million</strong> sqm of strategically positioned warehouse space
            </p>
          </div>
        </div>
      </div>
